			...
			do
			{
				...
				int stdage;
					...
					if(ch==1)
					{
						...
						log.info("Enter how many student you want");
						int n = s.nextInt();
						for(int i=0;i<n;i++) {
							...
							log.info("one std create successfully");
							log.info("-------------------------");
					...
					boolean found = false;
					log.info("Enter stdid to delete:");
					stdid = s.nextInt();
					log.info("----------------------------------");
					...
					if(ch==5) {
					boolean found = false;
					log.info("Enter stdid to update:");
					stdid = s.nextInt();
...
2023-02-27 16:45:55 INFO  CurdDemo:50 - Enter stdid
  101
2023-02-27 16:45:58 INFO  CurdDemo:53 - Enter stdname:
  aruna
...
2023-02-27 16:46:10 INFO  CurdDemo:63 - one std create successfully
  ...
  102
2023-02-27 16:46:16 INFO  CurdDemo:53 - Enter stdname:
  latha
...
2023-02-27 16:46:32 INFO  CurdDemo:80 - -------------------------
  ...
  3
2023-02-27 16:46:37 INFO  CurdDemo:96 - Enter stdid to search
  102
...
2023-02-27 16:46:51 INFO  CurdDemo:50 - Enter stdid
  104
2023-02-27 16:46:54 INFO  CurdDemo:53 - Enter stdname:
  deepthi
