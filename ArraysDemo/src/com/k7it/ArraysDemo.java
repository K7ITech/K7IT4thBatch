  ...
  and end with N-1.
     ...
     Example: 
       ...
       declaration and initalization:
        ...
        Arrays utility class:  there is a on class with the name of Arrays under java.util package 
        only
        ...
        2. Array size fixed , once you fix the array size we it wont increase automatically.
